...
floor_start <- 5
floor_decay <- 0.9
batch_sizes <- c(300, 100, 100, 100, 100, 100, 100, 100)
...
for(i in 1:niter){
  ...
  preds <- predict(cf.priority, xmat)$predictions[,,1]
  ...
  #### Linear TS, no floor 
  results <- run_experiment(ys, 0, floor_decay, batch_sizes, xs, balanced = 'none')
...
rownames(results_mat) <- c('uniform', 'LinTS', 'LinTS_floor', 'BLTS')
